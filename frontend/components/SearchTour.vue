    ...
    <div class="text-left">
      <Combobox v-model="selectedFrom">
        ...
        <div class="relative mt-1">
          <div
            class="relative z-50 w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm"
          >
            <ComboboxInput
          ...
          >
            ...
            >
              <div
                v-if="filteredFrom.length === 0 && queryFrom !== ''"
      ...
      <Combobox v-model="selectedTo">
        ...
        <div class="relative mt-1">
          ...
          >
            ...
            >
              <div
                v-if="filteredTo.length === 0 && queryTo !== ''"
                class="relative cursor-default select-none py-2 px-4 text-gray-700"
              >
                Ничего не найдено
              </div>
...
const itemsTo = [
  { id: 1, name: "Турция", unavailable: false },
  { id: 2, name: "Бали", unavailable: false },
  { id: 3, name: "Италия", unavailable: false },
];
